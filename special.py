...
async def add_skills(cursor):
    skills = [
        ...
        [
            "Берсерк",
            'Увеличивает урон в ближнем бою +2% за прокаченный уровень, но снижается при этом навыки "Крепость" на неопределенное количество поинтов (единиц EXP/Level)',
            "Пассивное умение",
            10,
            35,
            10,
        ...
        [
            "Мастерство крафта",
            "Позволяет создавать более сложные предметы, увеличивая шанс создания предмета на +0.1%.",
            "Пассивное умение",
            10,
            50,
            25,
        ...
        [
            "Инженер",
            "Позволяет более рационально пользоваться инструментами, а также увеличивает шанс создания предмета на +0.5%.",
            "Пассивное умение",
            10,
            75,
            25,
        ...
        [
            "Собиратель",
            "Увеличивает шанс найти более редкий предмет на +0.1%.",
            "Пассивное умение",
            15,
            50,
            25,
        ...
        [
            "Боевая медицина",
            "Увеличивает восстановление здоровья в безопасной зоне на +0.5%",
            "Пассивное умение",
            10,
            25,
            10,
        ...
        [
            "Толстая кожа",
            "Понижает количество получаемой радиации на +1%",
            "Пассивное умение",
            10,
            50,
            15,
        ...
        [
            'Меткий выстрел',
            "Повышает шанс нанести критический урон на +0.5%",
            "Активное умение",
            10,
            65,
            20,
        ...
        [
            'Ремонт',
            "Дает возможность ремонтировать предметы с прочностью (первый уровень). Далее эффективность ремонта повышается на +1%",
            "Пассивное умение",
            10,
            50,
            50,
